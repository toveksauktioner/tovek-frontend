...
/* * * *
 * Filename: creditsafeTableEdit.php
 * Created: 15/09/2014 by Renfors
 * Reference:
 * Description: View file for listing credit rating checkups made with Creditsafe.
 * * * */

$oCreditRating = clRegistry::get( 'clCreditRating', PATH_MODULE . '/creditRating/models' );
	$aDataDict = $oCreditRating->oDao->aDataDict;
	
$oCreditRating->oDao->setCriterias( array(
	'unpaid' => array(
		'fields' => 'ratingService',
		'value' => 'Creditsafe'
	)
) );
