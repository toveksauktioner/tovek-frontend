 ...
 *
 $Id: payread_post_api.php 1398 2014-03-31 14:41:09Z mikael $
...
class payread_post_api {
	...
	function payread_post_api() {		
		...
		$this->myAgentId          = PAYER_AGENT_ID;
		$this->myKeys["A"]        = PAYER_KEY1;
		$this->myKeys["B"]        = PAYER_KEY2;
		...
		$this->myFirewall         = $GLOBALS['PAYER_FIREWALL_ALLOWED_IP'];
	}
