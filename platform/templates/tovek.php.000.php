...
// if( !empty($_SESSION['userId']) ) {
	$sUserScripts .= '
		...
		<script src="/js/templates/tovek/init.js?ver=1"></script>
		<script src="/js/templates/tovek/dynamic.js.php?ver=3"></script>
		<script src="/js/templates/tovek/clock.js?ver=10"></script>';
// }
...
<head>
	...
	<!-- Stylesheet -->
	<link href="/css/index.php?include=templates/tovek/&ver=9" rel="stylesheet" />
	...
	<script src="/js/templates/tovek/auction.js?ver=16"></script>
